app.factory('AuthFactory', function($http,$q,UserFactory){
	var AUTH_URL = 'http://localhost:3000/auth/authenticate';
	var authFactory = {};
...
app.factory('AuthInterceptor', function($rootScope,$q,$location,UserFactory,NotifierFactory){
